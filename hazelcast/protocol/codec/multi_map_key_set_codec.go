...
const(
    // hex: 0x020400
    MultiMapKeySetCodecRequestMessageType  = int32(132096)
    // hex: 0x020401
    MultiMapKeySetCodecResponseMessageType = int32(132097)
...
func DecodeMultiMapKeySetResponse(clientMessage *proto.ClientMessage) []serialization.Data {
