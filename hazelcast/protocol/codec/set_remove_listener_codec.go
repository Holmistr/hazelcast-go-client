...
func EncodeSetRemoveListenerRequest(name string, registrationId internal.UUID) *proto.ClientMessage {
...
func DecodeSetRemoveListenerResponse(clientMessage *proto.ClientMessage) bool {
    ...
    return FixSizedTypesCodec.DecodeBoolean(initialFrame.Content, SetRemoveListenerResponseResponseOffset)
}
